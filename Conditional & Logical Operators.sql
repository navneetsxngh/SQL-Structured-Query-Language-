...
(60, 'Rashmi', 37, 73000, '2017-01-15', 'Mumbai'),
...
## List all employees who are getting salary more and less than 35000
...
## Find those employees who joined the company on 2025-12-08 and their salary 
## less than 35000
SELECT * FROM employee WHERE Hiring_Date = '2025-12-08' AND SALARY < 35000;

-- AND ---> All the conditions must TRUE
-- OR ---> Any one condition is TRUE

## Find those employees who joined the company after 2025-12-08 or their salary 
## greater than 40000
SELECT * FROM employee WHERE Hiring_Date = '2025-12-08' OR SALARY > 40000;

-- To use BETWEEN operation
## Find those employees who joined the company between 2019-12-08 to 2021-08-11
SELECT * FROM employee WHERE Hiring_Date BETWEEN '2019-12-08' AND '2021-08-11';
